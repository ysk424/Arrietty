...
現在の実装: Version 0.6.2 — 4周走行とOpenVR終了時クラッシュ対策、Blender XY方向補正、操舵ゲイン50%、速度連動の飛行モード
...
周回テストシーンは開始位置`(0, -10, 1.5)`、開始方向`+X`。1周は約143 mで、Version 0.6.2の走行終了距離は4周分の572 m。
...
`C:\Users\azoo\git\Arrietty\arrietty-0.6.2.zip`
...
同じ機能バージョンで配布ZIPを再ビルドするときも、成果物を上書きせずパッチ番号を1つ上げる。Version 0.6系では`0.6.0`、`0.6.1`、`0.6.2`のように増やす。
